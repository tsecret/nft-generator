...
contract NFT is ERC721, Ownable, Initializable  {
    ...
    constructor() ERC721("LtestNFTs", "LTFT") {
    ...
    {
        require(_contractOwner == msg.sender, "ERROR: Forbidden");
    ...
    function buy_for_lemon(uint _id, uint256 amount) external  {
        ...
        require(amount >= price[_id], "Error, the amount is lower");
        
        
        address _previousOwner = ownerOf(_id);
        address _newOwner = msg.sender;

        _trade_lemons(_id, amount);
    ...
    function _trade_lemons(uint _id, uint256 amount) internal {
        address payable _buyer = payable(msg.sender);
        address payable _owner = payable(ownerOf(_id));
        ...
        //_owner.transfer(_sellerValue);
        //_contractOwner.transfer(_commissionValue);
        TokenAddress.safeTransferFrom(_buyer,_owner,_sellerValue);
        TokenAddress.safeTransferFrom(_buyer,_contractOwner,_commissionValue);
